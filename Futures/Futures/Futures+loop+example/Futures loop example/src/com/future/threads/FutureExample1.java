...
public class FutureExample1 {
    ...
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        Instant start = Instant.now();
            ...
            InventoryChecker inventoryChecker = new InventoryChecker(future1.get()); // inventory checker waits for order fetcher
            System.out.println("Order Number is:" + future1.get());
            Future<Boolean> future2 = executor.submit(inventoryChecker);

            PaymentAcceptor paymentAcceptor = new PaymentAcceptor(future2.get()); // payment acceptor
