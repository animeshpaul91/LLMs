...
def ask_openai(audio_path: str,
    prompt : str = "") -> Translation:
...
if __name__ == "__main__":
    audio_file_path = "resources/french_audio.mp3"
    response: Translation = ask_openai(audio_path=audio_file_path)
